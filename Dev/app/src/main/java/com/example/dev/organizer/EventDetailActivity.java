...
//        if (isLoadingEvent || isPosterUpdating) {
...
//    private Button updatePosterBtn;
//
//    // ⭐ NEW: button to view waiting list
...
//        updatePosterBtn = findViewById(R.id.button_update_poster);
//
//        // ⭐ NEW: find the waiting-list button
...
//        updatePosterBtn.setOnClickListener(v -> showUpdatePosterDialog());
//
//        // ⭐ NEW: open the waiting list host activity, passing eventId
...
//            i.putExtra(OrganizerWaitingListActivity.EXTRA_EVENT_ID, eventId);
//            startActivity(i);
//        });
//    }
//
